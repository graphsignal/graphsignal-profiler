...
class ConfigLoaderTest(unittest.TestCase):
    def setUp(self):
        ...
        graphsignal.sdk.sdk().config_loader().clear()
    ...
    def test_update_config(self, mocked_get):
        ...
        graphsignal.sdk.sdk().config_loader().update_config()

        mocked_get.assert_called_once()
        self.assertEqual(graphsignal.sdk.sdk().config_loader().get_float_option('traces_per_sec'), 2.5)
        self.assertEqual(graphsignal.sdk.sdk().config_loader().get_int_option('some_opt'), 10_000_000)
    ...
    def test_update_config_defaults(self, mocked_get):
        ...
        self.assertEqual(graphsignal.sdk.sdk().config_loader().get_float_option('traces_per_sec'), 0.0)
        self.assertEqual(graphsignal.sdk.sdk().config_loader().get_int_option('some_opt'), 0)
    ...
    def test_update_config_fail(self, mocked_get):
        ...
        mocked_get.assert_called_once()
        self.assertIsNone(graphsignal.sdk.sdk().config_loader().get_float_option('traces_per_sec'))
        self.assertIsNone(graphsignal.sdk.sdk().config_loader().get_int_option('some_opt'))

    def test_get_config(self):
        graphsignal.sdk.sdk()._api_base = 'http://localhost:5006'
        ...
        self.assertEqual(graphsignal.sdk.sdk().config_loader().get_float_option('traces_per_sec'), 1.5)
        self.assertEqual(graphsignal.sdk.sdk().config_loader().get_int_option('some_opt'), 10_000_000)
    ...
    def test_update_callback_changed_options(self, mocked_get):
        ...
        graphsignal.sdk.sdk().config_loader().on_update(update_callback)
