...
class SignalUploaderTest(unittest.TestCase):
    def setUp(self):
        ...
        graphsignal.sdk.sdk().signal_uploader().clear()
    ...
    def test_flush(self, mocked_post):
        ...
        graphsignal.sdk.sdk().signal_uploader().upload_span(span_pb)
        graphsignal.sdk.sdk().signal_uploader().flush()

        mocked_post.assert_called_once()
        self.assertEqual(len(graphsignal.sdk.sdk().signal_uploader()._buffer), 0)
    ...
    def test_flush_fail(self, mocked_post):
        ...
        self.assertEqual(len(graphsignal.sdk.sdk().signal_uploader()._buffer), 2)

    def test_upload_signals(self):
        graphsignal.sdk.sdk()._api_base = 'http://localhost:5005'
        ...
        graphsignal.sdk.sdk().signal_uploader().upload_span(span_pb)
        graphsignal.sdk.sdk().signal_uploader().upload_metric(metric_pb)
        graphsignal.sdk.sdk().signal_uploader().upload_log_batch(log_batch_pb)
        graphsignal.sdk.sdk().signal_uploader().flush()
